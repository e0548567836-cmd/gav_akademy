...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _loadCurrentData() async {
    try {
      ...
      if (data != null) {
        ...
        _originalGrade = (data['grade'] ?? 80).toDouble();

        _nameController.text = _originalName;
        _emailController.text = _originalEmail;
        _phoneController.text = _originalPhone;
        _gradeController.text = _originalGrade.toString();
      }
    } catch (e) {
      _nameController.text = widget.userName;
      _originalName = widget.userName;
      _gradeController.text = '80';
    } finally {
  ...
  void _save() async {
    ...
    final newGrade = double.tryParse(_gradeController.text.trim()) ?? 80;

    final error = ValidationHelper.validateGrade(newGrade);
    ...
    if (newGrade != _originalGrade) {
      dataToUpdate['grade'] = newGrade;
    }
